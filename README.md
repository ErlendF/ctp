...
We used ~120 hours on this project, while 75 hours was expected. 
...
This Riot API key problem was fixed with a hack where its possible to post a new Riot Key to the application with the "/riotapikey" endpoint. See API endpoints.
